...
public class PreferenceConfiguration {
    ...
    private static final String WASD_MOUSE_CONTROLS_PREF_STRING = "checkbox_show_wasd_mouse_controls";
    private static final String WASD_SHOW_JOYSTICK_PREF_STRING = "checkbox_wasd_show_joystick";
    private static final String WASD_SHOW_MOUSE_PAD_PREF_STRING = "checkbox_wasd_show_mouse_pad";
    private static final String WASD_SHOW_LEFT_CLICK_PREF_STRING = "checkbox_wasd_show_left_click";
    private static final String WASD_SHOW_RIGHT_CLICK_PREF_STRING = "checkbox_wasd_show_right_click";
    private static final String WASD_SHOW_MIDDLE_CLICK_PREF_STRING = "checkbox_wasd_show_middle_click";
    private static final String WASD_OPACITY_PREF_STRING = "seekbar_wasd_opacity";
    ...
    private static final boolean DEFAULT_WASD_MOUSE_CONTROLS = false;
    private static final boolean DEFAULT_WASD_SHOW_JOYSTICK = true;
    private static final boolean DEFAULT_WASD_SHOW_MOUSE_PAD = true;
    private static final boolean DEFAULT_WASD_SHOW_LEFT_CLICK = true;
    private static final boolean DEFAULT_WASD_SHOW_RIGHT_CLICK = true;
    private static final boolean DEFAULT_WASD_SHOW_MIDDLE_CLICK = true;
    private static final int DEFAULT_WASD_OPACITY = 90;
    ...
    public boolean wasdMouseControls;
    public boolean wasdShowJoystick;
    public boolean wasdShowMousePad;
    public boolean wasdShowLeftClick;
    public boolean wasdShowRightClick;
    public boolean wasdShowMiddleClick;
    public int wasdOpacity;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.wasdMouseControls = prefs.getBoolean(WASD_MOUSE_CONTROLS_PREF_STRING, DEFAULT_WASD_MOUSE_CONTROLS);
        config.wasdShowJoystick = prefs.getBoolean(WASD_SHOW_JOYSTICK_PREF_STRING, DEFAULT_WASD_SHOW_JOYSTICK);
        config.wasdShowMousePad = prefs.getBoolean(WASD_SHOW_MOUSE_PAD_PREF_STRING, DEFAULT_WASD_SHOW_MOUSE_PAD);
        config.wasdShowLeftClick = prefs.getBoolean(WASD_SHOW_LEFT_CLICK_PREF_STRING, DEFAULT_WASD_SHOW_LEFT_CLICK);
        config.wasdShowRightClick = prefs.getBoolean(WASD_SHOW_RIGHT_CLICK_PREF_STRING, DEFAULT_WASD_SHOW_RIGHT_CLICK);
        config.wasdShowMiddleClick = prefs.getBoolean(WASD_SHOW_MIDDLE_CLICK_PREF_STRING, DEFAULT_WASD_SHOW_MIDDLE_CLICK);
        config.wasdOpacity = prefs.getInt(WASD_OPACITY_PREF_STRING, DEFAULT_WASD_OPACITY);
